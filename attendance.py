...
class Attendance:
    ...
    def __init__(self,root,show_main_app_callback):
        ...
        date_entry = Entry(left_frame,textvariable=self.var_date,width=15,font=("verdana",12,"bold"))
        ...
        # Right Label Frame 
        right_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Attendance Records",font=("verdana",12,"bold"),fg="navyblue")
        right_frame.place(x=680,y=15,width=660,height=480)
        ...
        table_frame.place(x=10,y=25,width=635,height=360)
    ...
    #Update button
        ...
        update_btn=Button(right_frame,command=self.exportCsv,text="Export CSV",width=12,font=("verdana",12,"bold"),fg="white",bg="navyblue")
        update_btn.grid(row=0,column=1,padx=10,pady=400,sticky=W)
    #Update button
        del_btn=Button(right_frame,command=self.delete_data,text="Delete",width=12,font=("verdana",12,"bold"),fg="white",bg="navyblue")
        del_btn.grid(row=0,column=2,padx=340,pady=400,sticky=W)
