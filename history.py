...
class History:
    def __init__(self, root, show_main_app_callback):
        ...
        # Background image
        bg_img = Image.open(r"C:\Users\Leanne France Loyola\Desktop\Python-FYP-Face-Recognition-Attendence-System\Images_GUI\t_bg1.jpg")
        ...
        canvas.place(x=20, y=65, width=1300, height=500)
