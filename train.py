...
class Train:
    ...
    def __init__(self,root, show_main_app_callback):
        ...
        # back_btn=Button(bg_img,command=self.back_button,text="Back",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#002B53",bg="white",activeforeground="white",activebackground="#007ACC")
        # back_btn.place(x=10,y=0,width=50,height=45)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"C:\Users\Leanne France Loyola\Desktop\Python-FYP-Face-Recognition-Attendence-System\Images_GUI\t_btn1.png")
